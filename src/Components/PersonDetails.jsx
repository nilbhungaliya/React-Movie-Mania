...
import { HorizontalCard, Loading } from "./index";
import Dropdown from "./Tampletes/Dropdown";
...
function PersonDetails() {
  ...
  return info ? (
    <div className=" w-screen overflow-y-scroll bg-[#1F1E24] px-[2%] py-[1%]">
      {/* Part 1 navigation */}
      <nav className="h-[10vh] w-full text-zinc-100 flex items-center gap-10 text-xl px-[3%]">
        <Link
          onClick={() => navigate(-1)}
      ...
      <div className="w-full flex px-[6%]">
        ...
        <div className="w-[20%] ">
          ...
          <h1 className=" text-zinc-400 ">
            {info.detail.birthday ? info.detail.birthday : "not found"}
          </h1>
